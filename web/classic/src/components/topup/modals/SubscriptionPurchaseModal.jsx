...
const SubscriptionPurchaseModal = ({
  ...
  const hasAnyPayment = hasStripe || hasCreem || hasEpay || allowBalancePay;
              ...
              {plan?.daily_enabled && (
                <div className='flex justify-between items-center'>
                  ...
                  <div className='flex items-center'>
                    ...
                    <Text className='text-slate-900 dark:text-slate-100'>
                      {renderQuota(Number(plan?.daily_limit || 0))}
                    </Text>
                  </div>
                </div>
              )}
              {plan?.weekly_enabled && (
                <div className='flex justify-between items-center'>
                  ...
                  <div className='flex items-center'>
                    <Package size={14} className='mr-1 text-slate-500' />
                    <Text className='text-slate-900 dark:text-slate-100'>
                      {renderQuota(Number(plan?.weekly_limit || 0))}
                    </Text>
                  </div>
                </div>
              )}
              {plan?.monthly_enabled && (
                <div className='flex justify-between items-center'>
                  ...
                  <div className='flex items-center'>
                    <Package size={14} className='mr-1 text-slate-500' />
                    <Text className='text-slate-900 dark:text-slate-100'>
                      {renderQuota(Number(plan?.monthly_limit || 0))}
                    </Text>
                  </div>
                </div>
              )}
