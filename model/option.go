...
func InitOptionMap() {
	...
	common.OptionMap["AffRebateMode"] = strconv.Itoa(common.AffRebateMode)
	common.OptionMap["AffRebatePercentage"] = strconv.FormatFloat(common.AffRebatePercentage, 'f', -1, 64)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "AffRebateMode":
		common.AffRebateMode, _ = strconv.Atoi(value)
	case "AffRebatePercentage":
		common.AffRebatePercentage, _ = strconv.ParseFloat(value, 64)
